...
class TestCubeEqualiser(unittest.TestCase):
    ...
    def test_equalise_attributes(self):
        ...
        for cubes in test_load:
            self.assertEqual(cubes.attributes,
                             test_load[0].attributes)
    ...
    def test_sort_by_earliest_date(self):
        ...
        self.assertEqual(test_load[3].dim_coords[0].units.origin,
                         'days since 2030-01-01 00:00:00')
        self.assertEqual(test_load[4].dim_coords[0].units.origin,
                         'days since 2040-01-01 00:00:00')
        self.assertEqual(test_load[5].dim_coords[0].units.origin,
                         'days since 2050-01-01 00:00:00')
        self.assertEqual(test_load[6].dim_coords[0].units.origin,
                         'days since 2060-01-01 00:00:00')
        self.assertEqual(test_load[7].dim_coords[0].units.origin,
                         'days since 2070-01-01 00:00:00')
        self.assertEqual(test_load[8].dim_coords[0].units.origin,
                         'days since 2080-01-01 00:00:00')
        self.assertEqual(test_load[9].dim_coords[0].units.origin,
                         'days since 2090-01-01 00:00:00')
        self.assertEqual(test_load[10].dim_coords[0].units.origin,
                         'days since 2100-1-1')
